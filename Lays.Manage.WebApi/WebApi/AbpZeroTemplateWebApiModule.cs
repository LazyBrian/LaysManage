    ...
    public class AbpZeroTemplateWebApiModule : AbpModule
    {
        ...
        private void ConfigureSwaggerUi()
        {
            Configuration.Modules.AbpWebApi().HttpConfiguration
                .EnableSwagger(c =>
                {
                    c.SingleApiVersion("v1", "Lays.Manage.WebApi");
                    c.ResolveConflictingActions(apiDescriptions => apiDescriptions.First());
                })
                .EnableSwaggerUi(c =>
                {
                    c.InjectJavaScript(Assembly.GetAssembly(typeof(AbpZeroTemplateWebApiModule)), "Lays.Manage.WebApi.Scripts.Swagger-Custom.js");
                });
        }
    }
}
