...
using Lays.Manage.Web.App.Startup;//SPA!
using Lays.Manage.Web.Areas.Mpa.Startup;//MPA!
using Lays.Manage.Web.Bundling;
using Lays.Manage.Web.Navigation;
using Lays.Manage.Web.Routing;
using Lays.Manage.WebApi;
